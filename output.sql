...
--
-- Host: localhost    Database: autoshop
-- ------------------------------------------------------
...
CREATE TABLE `cards` (
  ...
  `vbv` varchar(100) DEFAULT NULL,
  `address` text,
  `zip` varchar(50) DEFAULT NULL,
  `city` varchar(20) DEFAULT NULL,
  `country` varchar(20) DEFAULT NULL,
  `price` varchar(20) DEFAULT NULL,
  `supplement` varchar(20) DEFAULT NULL,
...
--
-- Table structure for table `reports_messages`
--

DROP TABLE IF EXISTS `reports_messages`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
...
--
-- Dumping data for table `reports_messages`
--

LOCK TABLES `reports_messages` WRITE;
/*!40000 ALTER TABLE `reports_messages` DISABLE KEYS */;
/*!40000 ALTER TABLE `reports_messages` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `reviews` VALUES (1,5,1,1,23,5);
