            ...
            <section class="content">                
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <h6 class="card-subtitle">You can Edit, Remove, and Control your users. </h6>
                            <input type="hidden" name="tboob" value="d652c24ec3bfe85d77920c4e1c311a32">                                
                                <div id="BoobsTable_wrapper" class="dataTables_wrapper no-footer"><!--<div style="display: none" class="dataTables_length" id="BoobsTable_length">
                            ...
                            <?php echo $pdo->getUserList(); ?>
                            
                            <div style="display: none" class="dataTables_info" id="BoobsTable_info" role="status" aria-live="polite">Showing 1 to 4 of 4 entries</div><div style='display: none' class="dataTables_paginate paging_simple_numbers" id="BoobsTable_paginate"><a class="paginate_button previous disabled" aria-controls="BoobsTable" data-dt-idx="0" tabindex="0" id="BoobsTable_previous">Previous</a><span><a class="paginate_button current" aria-controls="BoobsTable" data-dt-idx="1" tabindex="0">1</a></span><a class="paginate_button next disabled" aria-controls="BoobsTable" data-dt-idx="2" tabindex="0" id="BoobsTable_next">Next</a></div></div>                               
                        </div>
                    </div>                                   
            </section>
