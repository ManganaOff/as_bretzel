    ...
    <main class="main">
		...
		<main>
            ...
            <?php if(isset($_GET['send']) && $_GET['send'] == "success"){
                echo '<div class="alert alert-success ">Your item(s) has been successfully sent to an Administrator. They will be added to the shop once approved.</div>';
            }
            ?>
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <h4 class="card-title">Credit Cards Shop</h4>
                            <h6 class="card-subtitle">Vous pouvez trouver dans cette section nos nouvelles cartes fresh au meilleur prix. </h6>
<!-- 						<h6 class="card-subtitle">Buy only Checked CC  , You can open a report in just 2h after buying it , otherwise we will reject the report </h6>
 -->                                  <?php echo $pdo->getAllCards()?>                                        
                        </div>
                    </div>                                   
            </section>
