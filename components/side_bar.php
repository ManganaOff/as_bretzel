                        ...
                        <ul class="navigation">
                            ...
                            <li class="@@index"><a href=" http://localhost/as_bretzel/index.php"><i class="fas fa-home"></i> Accueil</a></li>
                                ...
                                <?php 
                                    ...
                                    $total_refund = $pdo->getCountTotalRefundsPending();
                                ...
                                <li id="head_admin" class="navigation__sub navigation__sub">
                                    ...
                                    <ul id="dropdown_admin">
                                        ...
                                        <li class="@@typeactive"><a href="http://localhost/as_bretzel/admin/refunds.php">Refund requests <span class="badge bg-<?php echo $color_refund ?>" style="float: right; border-radius: 100px"><?php echo $total_refund ?></a></li>
