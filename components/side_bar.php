                            ...
                            <li class="@@index"><a href=" http://144.202.124.151/index.php"><i class="fas fa-home"></i> Accueil</a></li>
                                ...
                                <li id="head_admin" class="navigation__sub navigation__sub">
                                    ...
                                    <ul id="dropdown_admin">
                                        ...
                                        <li class="@@typeactive"><a href="http://144.202.124.151/admin/refunds.php">Refund requests <span class="badge bg-<?php echo $color_refund ?>" style="float: right; border-radius: 100px"><?php echo $total_refund ?></a></li>
